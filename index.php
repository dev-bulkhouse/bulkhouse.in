                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="navbar-collapse collapse">
                                            ...
                                            <a  data-toggle="modal" data-target="#Register_model" style="float:right; margin-top:20px;margin-left: 10px; color: white" class="btn btn-primary" type="submit"><i></i>Register as a Seller</a>   
                                            <a  data-toggle="modal" data-target="#myModal" style="float:right; margin-top:20px; color: white" class="btn btn-primary" type="submit"><i class="fa fa-lock"></i> Seller Login</a>
                ...
                <div id="main-slider">
                    <div id="carousel-example-generic1" class="carousel slide carousel-fade" data-ride="carousel" data-pause="false">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <!--                            <div class="item">
                                                            <img src="img/s2.jpg" alt="" title="" width="2000" height="1080">
                                                        ...
                                                        <div class="item">
                                                            <img src="img/s1.jpg" alt="" title="" width="2000" height="1080">
                                                             <div class="carousel-caption">
                            ...
                            <div class="item active">
                                <img src="img/1.jpg" alt="" title="" width="1500" height="600">
                                <!-- <div class="carousel-caption">
                                     <h1 class="upper animation animated-item-1"><span class="text-color">Premium</span> HTML5 Template</h1>
                            ...
                            <div class="item">
                                <img src="img/2.jpg" alt="" title="" width="1500" height="800">
                                <!-- <div class="carousel-caption">
                                     <h1 class="upper animation animated-item-1"><span class="text-color">Premium</span> HTML5 Template</h1>
                                     <p class="description  animation animated-item-2 pad-20 hidden-sm hidden-xs">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae odit iste exercitationem <br>praesentium deleniti nostrum laborum rem id nihil tempora.</p>
                                 </div>-->
                            ...
                            <div class="item">
                                <img src="img/3.jpg" alt="" title="" width="1500" height="800">
                                <!-- <div class="carousel-caption">
                                     <h1 class="upper animation animated-item-1"><span class="text-color">Premium</span> HTML5 Template</h1>
                                     <p class="description  animation animated-item-2 pad-20 hidden-sm hidden-xs">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae odit iste exercitationem <br>praesentium deleniti nostrum laborum rem id nihil tempora.</p>
                                 </div>-->
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form  action="http://sellers.bulkhouse.in/user/login_user" method="post">
                                <div class="form-group">
            ...
            <div id="fgtPassword" class="modal fade" role="dialog" style="z-index: 9999">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form  action="http://sellers.bulkhouse.in/login/reset_password" method="post">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Email address</label>
                                    <input type="email" name="email" class="form-control" id="exampleInputEmail1" placeholder="Email">
                                </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Register For</label>
                                <select class="form-control" id="register_for">
                            ...
                            <div id="Export" style="display: none">
                                <form  id="form_reg" action="http://sellers.bulkhouse.in/register/register_user" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Firm Type <small>required</small></label>
                                <select class="form-control" id="register_for" name="firm_type" required="required">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Company Name <small>required</small></label>
                                        <input class="form-control"  name="firm_name" type="text" id="right-label" placeholder="Please enter your Company Name" required="required">
                            </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">First Name<small>required</small></label>
                                        
                                        <input class="form-control" name="firstname" type="text"  id="right-label" placeholder="Firstname" required="required">
                            </div>
                            <div class="form-group">
                                        <label for="exampleInputEmail1">Last Name <small>required</small></label>
                                       
                                        <input class="form-control" name="lastname" type="text"  id="right-label" placeholder="Lastname" required="required">
                            </div>
                                    ...
                                    <input class="form-control" name="mobile" type="number"  id="right-label" pattern="^[7-9][0-9]{9}$" placeholder="Please enter your Mobile number" required="required">
                                    </div>
                                    
                                <div class="checkbox">
                                    <label>
                                    <input type="checkbox" required="required"> I agree to the Terms & Conditions (Export <a href="http://sellers.bulkhouse.in/export_terms">)View</a>
                                    </label>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <label for="exampleInputEmail1">Confirm Password</label>
                                    <input type="email"  id="confirm_password"   class="form-control" placeholder="Confirm password" required="required">
                                </div>
                                    <div class="form-group">
                                    <label for="exampleInputEmail1">Phone Number</label>
                                    <input class="form-control" name="mobile" type="number"  id="right-label" pattern="^[7-9][0-9]{9}$" placeholder="Please enter your Mobile number" required="required">
                                ...
                                <div class="checkbox">
                                    ...
                                    <label>
                                    <input type="checkbox" required="required"> I agree to the Terms & Conditions (Domestic <a href="http://sellers.bulkhouse.in/domestic_terms">)View</a>
                                    </label>
                                </div>
                                    <button type="submit" class="btn btn-default">Register</button>
                                     </form>
                        ...
                        <div class="col-md-6 pad-60 medium-6 columns">
                            ...
                            <div class="col-md-12 medium-12 columns text-justify">
                                ...
                                <p style="font-family: 'Roboto Condensed', sans-serif; font-size: 15px">
                                    Bulkhouse is a privately held company incorporated in March 2015 in Visakhapatnam India.

                                    Bulkhouse will be operating on a B2B trade model for its International and domestic trading 

                                    business from its online web portals. A blend of a Marketplace cum store model makes it 

                                    unique for the Buyers and Vendors to do business on Bulkhouse.</p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div>
                                <img src="img/transport.jpg" alt="" title="" width="450" height="600">
                            </div>
                        </div>
                        <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 medium-4 columns">
                                ...
                                <div>
                                    <img src="img/world_carton.jpg" alt="" title="" width="450" height="600">
                                </div>
                            </div>
                        </div>
